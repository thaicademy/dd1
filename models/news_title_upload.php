...
//-------------------------------------------------------
    ...
    $name = $id . '.' . $ext;
//-------------------------------------------------------
    $smt = $pdo->prepare("UPDATE news SET filename='$name'  WHERE id=$id");
    $smt->execute();
//-------------------------------------------------------
...
//------------------------------
    if ($ext == "jpg") {imagejpeg($new_img, "./public/news/title/$name");} else if ($ext == "png") {imagepng($new_img, "../public/news/title/$name");} else if ($ext == "gif") {imagegif($new_img, "../public/news/title/$name");}
//--------------------------------
