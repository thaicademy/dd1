...
//-------------------------------------------------------
    ...
    $name = $id . '.' . $ext;
//-------------------------------------------------------
    $smt = $pdo->prepare("UPDATE activity  SET photo='$name'  WHERE id='$id'");
    $smt->execute();
//-------------------------------------------------------
...
//------------------------------
    if ($ext == "jpg") {imagejpeg($new_img, "../public/activity/title/$name");} else if ($ext == "png") {imagepng($new_img, "../public/activity/title/$name");} else if ($ext == "gif") {imagegif($new_img, "../public/activity/title/$name");}
//--------------------------------
